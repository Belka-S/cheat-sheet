...
// 4. As soon as the user has filled in all the fields and submitted the form, collect the field
// values into an object, where the field name will be the property name and the field value will
// be the property value. Use the elements property to access form elements.
