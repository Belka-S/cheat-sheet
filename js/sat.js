...
// const alertBtnEl = document.querySelector('button#alertButton');
// const alertInputEl = document.querySelector('input#alertInput');
...
//   leftInputEl: document.querySelector('#leftSwapInput'),
//   rightInputEl: document.querySelector('#rightSwapInput'),
// };
...
// ref.btnEl.addEventListener('click', onClick);
...
// ref.divEl.addEventListener('click', onClick);

// function onClick(e) {
//   switch (e.target.id) {
//     case 'decrease':
//       ref.boxEl.style.height = `${ref.boxEl.clientHeight - 10}px`;
//       ref.boxEl.style.width = `${ref.boxEl.clientWidth - 10}px`;
//       break;
...
// const listElArray = document.querySelectorAll('.list .listItem');
...
//       innerEl.style.top = `${e.pageY - innerEl.clientHeight / 2}px`;
//       innerEl.style.left = `${e.pageX - innerEl.clientWidth / 2}px`;
//     });
...
//   resultDivEl: document.querySelector('#resultSection'),
// };

// ref.divEl.addEventListener('click', sumOnClick);
...
// ref.resultBtnEl.addEventListener(
//   'click',
//   e => (ref.resultDivEl.textContent = sum)
// );
...
// const listElArray = document.querySelectorAll('ul li.person');
// const nameBtnEl = document.querySelector('#sortByNameButton');
// const lastBtnEl = document.querySelector('#sortByLastNameButton');

// const peopleArray = [];
// listElArray.forEach(el => peopleArray.push(el));

// nameBtnEl.addEventListener('click', onClick);
// lastBtnEl.addEventListener('click', onClick);
...
//   array.sort((a, b) =>
//     a.textContent.split(/\s+/)[1].localeCompare(b.textContent.split(/\s+/)[1])
//   );
// }
...
// const inputEl = document.querySelector('input.contactsFilter');
// const ulEl = document.querySelector('ul.contacts');
// const liElArray = document.querySelectorAll('li.contact');
...
//     el.textContent.toLowerCase().includes(inputEl.value.toLowerCase())
//   );

//   ulEl.innerHTML = '';
//   sortContact.forEach(el => ulEl.append(el));
// }
...
// ref.fromEl.addEventListener('input', onInput);
// ref.toEl.addEventListener('input', onInput);
// ref.btnEl.addEventListener('click', onClick);

// let content = '';

// function onInput(e) {
//   replace(ref.fromEl.value, `<span>${ref.fromEl.value}</span>`);

//   const spanEl = ref.textEl.querySelectorAll('span');
//   spanEl.forEach(el => (el.style.backgroundColor = 'lightsalmon'));
// }

// function onClick(e) {
//   replace(ref.fromEl.value, ref.toEl.value);
// }

// function replace(value, newValue) {
//   content = ref.textEl.textContent;
//   ref.textEl.innerHTML = content.replaceAll(value, newValue);
// }
...
// const ulEl = document.querySelector('ul.grid');

// ulEl.addEventListener('mouseover', onMouseover);
// ulEl.addEventListener('mouseout', onMouseout);

// function onMouseover(e) {
//   if (e.target.classList.contains('gridItem')) {
//     e.target.style.backgroundColor = 'transparent';
//     e.target.style.borderColor = 'transparent';
//     e.target.style.transition = 'background-color 300ms linear';
//   }
// }
