...
4. ### What is JSX in ReactJS?
   ...
   JSX stands for JavaScript Syntax. It is a JavaScript extension that allows us to describe React's
   object tree using a syntax that resembles that of an HTML template. It is just an XML-like
   extension that allows us to write JavaScript that looks like markup and have it returned from a
   component.
...
15. ### What is the significance of the "Fragment" component?

    "Fragment" is a component in ReactJS that allows you to group multiple elements without adding
    extra DOM elements. It helps keep the rendered output clean and is particularly useful when you
    don't want to introduce additional wrappers or nesting levels.
...
17. ### What are the differences between class components and functional components?
...
23. ### What are Pure Components?
    ...
    Pure Components are the components that do not re-render when the value of props and state has
    been updated with the same values. Since these components do not cause re-rendering when the
    same values are passed thus they improve performance.
...
32. ### How does useReducer differ from the useState hook?
...
33. ### Describe the purpose of the useRef hook.
    ...
    doesn't need to trigger a re-render. The useRef hook allows components to retain a reference to
    a specific value or element throughout their lifecycle.

34. ### What is the purpose of the useMemo hook?
...
35. ### When would you use the useCallback hook in React?
    ...
    dependencies remain unchanged. This optimization can improve performance in certain situations
    by preventing unnecessary function recreations.
...
42. ## How can we avoid prop drilling?
    ...
    Redux, which allow more efficient and organized sharing of data across components.
...
44. ### Why React uses className over class attribute?
    ...
    JavaScript. Using `class` would cause conflicts with JavaScript syntax."

45. ### Why we should not update state directly?
...
46. ### What is StrictMode in React?
...
47. ### What's wrong with using Context in React?
...
48. ### Does React re-render all components every time setState is called?
...
49. ### Explain why and when would you use useMemo?
    ...
    operations by caching the computed value until its dependencies change.

50. ### How does React renderer work exactly when we call setState?
...
52. ### What are the advantages of Styled Components?
    ...
    performance. They enhance code organization, make styles more maintainable.

53. ### Why props cannot be updated in ReactJS?

    Props cannot be updated in ReactJS due to React core philosophy. It focused on making the props
    immutable and top-down thus, a parent can send any prop values to a child but child cannot
    change the received prop.

54. ### What is a dispatcher?
...
55. ### What are default props?

    Default props are used to define default values for props in a component. Default props ensure
    that if a parent component doesn't provide a value for a certain prop, the component will still
    have a default value to work with.

56. ### What are inline conditional expressions?

    In JSX, you can include any JavaScript expression within curly braces and use it with
    conditional (ternary) operators.

57. ### What are the differences between React and React Native?
...
58. ### Is React a library or a framework and why?
...
59. ### What are nested components in React?
...
60. ### Can a nested child component access the state of its sibling component?

    A nested child component cannot directly access the state of its sibling component. If sibling
    components need to communicate or share data, it is recommended to lift the shared state up to
    their common parent component and pass it down as props to both siblings.

61. ### What are error boundaries in React?
...
62. ### What are React DevTools?

    React DevTools are a browser extension that helps developers debug and inspect React
...
63. ### What is "React Node" in React?

    "React Node" is a term used to describe any content that can be rendered within a React
    component. It could be HTML elements, other React components, text, numbers, or fragments.

64. ### Why do we need to React Router?

    It maintains consistent structure and behavior and is used to develop single-page web
    applications. Enables multiple views in a single application by defining multiple routes.ß

65. ### Explain the role of Reducer.
...
66. ### Can you explain React's "lifting state up" concept?
...
67. ### What is a ref in React and what is its purpose?
...
68. ### How does using refs differ from traditional DOM manipulation?
...
69. ### Explain the concept of "forwarding refs" in React.
...
70. ### How do refs affect the component lifecycle in React?
...
71. ### What are the benefits of using callback refs over string refs?
...
72. ### Can we use refs with functional components in React?
...
73. ### What are the limitations or caveats of using refs in React?
    ...
    can lead to code that is harder to maintain and test.

74. ### How do you clean up or release the resources associated with a ref in React?
...
75. ### How do you access the DOM node using refs in React?
...
76. ### What happens if you don't bind a function in React?
...
77. ### How can you bind a function in a React class component?
...
78. ### What is the recommended approach for binding functions in React components?
...
79. ### Explain the difference between binding in class and functional components in React.
...
80. ### What is the difference between Element and Component in React?
...
81. ### How to apply validation on props in React?
...
82. ### Why is a React component declarative?
...
84. ### How is React different from Angular?
...
85. ### Explain the use of CSS modules in React.
...
86. ### Can you explain what custom hooks are in React?

    Custom hooks in React are reusable JavaScript functions that allow you to extract logic and
    stateful behavior from components. Custom hooks are created by developers to encapsulate
    specific logic that can be shared across multiple components.

87. ### What are the benefits of using custom hooks in React?
...
89. ### Are there any limitations or considerations when using custom hooks in React?
    ...
    hooks like calling them at the top level and avoiding conditional usage.

90. ### What is Formik, and why would you use it in a React application?
...
91. ### What are the advantages of using Formik?
...
92. ### What is Axios, and what problem does it solve in JavaScript or React development?
...
93. ### What are the advantages of using Axios over the built-in fetch API in JavaScript?
...
94. ### What is Material-UI and its purpose in React development?
    ...
    and user-friendly interfaces. With Material-UI, developers can focus on functionality while
    simplifying the process of styling and creating responsive layouts.

95. ### What is Suspense component?

    If the module containing the dynamic import is not yet loaded by the time parent component
    renders, you must show some fallback content while you’re waiting for it to load using a loading
    indicator. This can be done using Suspense component.

96. ### Is it possible to use react without JSX?
    ...
    `createElement` function provided by React, which takes the element type, props, and children as
    arguments.
...
97. ### Why does Strict Mode render twice in React?
...
100. ### What is a wrapper component in react?
...
102. ### What are the dependencies in the dependency array of the useEffect hook?
...
103. ### What are some common use cases for the useEffect hook?
...
104. ### Can you explain the concept of multiple useEffect hooks in a single component?
...
105. ## What is the purpose of the cleanup function returned by the useEffect hook?
...
106. ### What are the potential pitfalls or common mistakes when using the useEffect hook?
     ...
     without proper dependency management, resulting in unexpected behavior.

107. ### Why would you choose to use server-side rendering instead of client-side rendering?
...
108. ### How does server-side rendering differ from client-side rendering in React.js?

     Server-side rendering (SSR) differs from client-side (CSR) rendering in that the rendering
     process occurs on the server before sending the HTML to the client, whereas client-side
     rendering renders components in the browser.

109. ### Explain the benefits and drawbacks of server-side rendering in React.js.
...
110. ### What are the performance implications of server-side rendering in React.js?
...
111. ### How can you implement server-side rendering with React.js without using frameworks like Next.js?
...
112. ### Describe the steps involved in setting up server-side rendering with React.js from scratch.
...
113. ### What libraries or tools can be used to perform server-side rendering with React.js?

     Libraries like react-dom/server, ReactDOMServer, and Express can be used to perform server-side
     rendering with React.js.

114. ### How can you handle data fetching and asynchronous operations during server-side rendering in React.js?
...
115. ### Can you explain the concept of code splitting?

     Code splitting is the process of splitting the JavaScript bundle into smaller chunks to improve
     performance.

116. ### How can you optimize server-side rendered React.js applications for search engine optimization (SEO)?
...
117. ### What are the best practices for organizing and structuring a React application?
...
118. ### How do you handle authentication and authorization in React applications?
...
119. ### What are the pros and cons of using React in a project compared to other JavaScript frameworks?
